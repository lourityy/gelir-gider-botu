...
// discord.gg/altyapilar - Lourity
        if (input === 'gelir') {
            const main_data = db.get(`gelirData_${interaction.guild.id}`)
...
// discord.gg/altyapilar - Lourity
        if (input === 'gider') {
            const main_data = db.get(`giderData_${interaction.guild.id}`)
...
// discord.gg/altyapilar - Lourity
        if (input === 'sifirla') {
            ...
            db.delete(`para_${interaction.guild.id}`)
            db.delete(`giderData_${interaction.guild.id}`)
            db.delete(`gelirData_${interaction.guild.id}`)
